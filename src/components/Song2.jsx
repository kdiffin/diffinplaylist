...
export default function Song2(props) {
  ...
  return (
    <div>
      <div className="image">
        <img className="coverImg" src={props.coverImg}></img>
      ...
      <div className="songAttributes">
        <a href={props.articleLink} className="songTitle">
          {props.title}
        </a>
        <div className="stats">
          ...
          <p className="cover">
            Doğum tarixi: {props.stats.birth} <br />
            Məşğuliyyəti: {props.stats.job}
          </p>
        </div>
      </div>
    </div>
